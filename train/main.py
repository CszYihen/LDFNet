...
from datasetTrain_grayscale import cityscapes
...
def train(args, model, classNum, epochNum, encoderOnly=False):
    ...
    if args.dataset == 'cityscapes':
        ...
        dataDir = r'D:\PycharmProject\datasets\cityscapes'
        dataset_train = cityscapes(dataDir, co_transform, 'train')
        dataset_val = cityscapes(dataDir, co_transform_val, 'val')
        saveDir = f'../save/{args.saveDir}' # #

    loader_train = DataLoader(dataset_train, num_workers=args.num_workers, batch_size=args.batchSize, shuffle=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mainRoute', default="D:\PycharmProject\LDFNet\\")  # change the path to your main file
    parser.add_argument('--model', default="LDFNet")                     # specify your own network file here
    parser.add_argument('--modelRoute', default="model\\")
    ...
    parser.add_argument('--iter-loss', type=int, default=100)
